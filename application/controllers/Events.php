...
class Events extends CI_Controller
{
    ...
    public function view()
    {
        ...
        $data['page_title'] = "BISD - Manage Events";
...
// called in form validation to validate end time
    ...
    {
        $ownTime = $this->security->xss_clean($ownTime);
        $start_time = $this->security->xss_clean($start_time);
    ...
    public function create()
    {
        if ($_POST)
        {
            ...
            if ($this->form_validation->run('event'))
            {
                ...
                else
                {
                    ...
                    $whListKey = array(
                        'event_id', 'name', 'time_start', 'time_end', 'address', 'venue', 'custom_venue','description', 'ev_img_path', 'stat',
                    );
        ...
        $data['page_title'] = "BISD - Create Events";
    ...
    public function update($id = '')
    {
        ...
        $data['page_title'] = "BISD - Update Event";
    ...
    public function create_venue()
    {
        ...
        $data['page_title'] = "BISD - Create Venue";
        ...
        else
        {
            ...
            if (!empty($id))
            {
                if ($venue = $this->Event_model->getAllVenue('', 'venue_id = \'' . $id . '\''))
                {
                    ...
                    $data['page_title'] = "BISD - Update Venue";
