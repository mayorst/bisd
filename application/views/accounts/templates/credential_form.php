<?php
     ...
     * viewOldPass - displays new pass input.
     *
...
<?php form_input_wLabel(array('label' => 'username'), (($type === pv::UPDATE) ? $userInfo['username'] : ''));?>
    ...
    <?php if (in_array('viewOldPass', $view_setting)) {
            form_input_wLabel(array('label' => 'old_password', 'input' => array('type' => 'password')));
        }
    ?>
    ...
    <?php if (!in_array('noConfirmPassword', $view_setting)) {
            form_input_wLabel(array('label' => 'Confirm Password', 'input' => array('type' => 'password')));
    }?>
